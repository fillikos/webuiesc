...
@XmlType(propOrder = {"dateTime", "timeString", "laps", "minutes", "stream",
        "formationAndStart", "mostLapsCompleted", "driver"})
@XmlRootElement(name = "Race")
public class Race {

    private long dateTime, laps;
    private String timeString;
    private int minutes, mostLapsCompleted, formationAndStart;
...
//		stream = new Stream();
    ...
    @XmlElement(name = "FormationAndStart")
    public int getFormationAndStart() {
        return formationAndStart;
    }

    public void setFormationAndStart(int formationAndStart) {
        this.formationAndStart = formationAndStart;
    }
